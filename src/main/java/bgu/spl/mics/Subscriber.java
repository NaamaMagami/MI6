...
import bgu.spl.mics.application.ThreadesCounter;
...
public abstract class Subscriber extends RunnableSubPub {
    ...
    private Map<Class<? extends Message>, Callback> messageCallbacks=new ConcurrentHashMap<Class<? extends Message>, Callback>();;
    ...
    public final void run() {
        ...
        initialize();
        ThreadesCounter.getInstance().IncreaseCounter();
        while (!terminated) {
            try{
